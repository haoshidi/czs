...
import com.czscloud.czs.common.security.exception.UnauthorizedException;
import com.czscloud.czs.common.security.service.MyUser;
import com.czscloud.czs.common.security.service.MyUserDetailsService;
...
public class MyLocalResourceServerTokenServices implements ResourceServerTokenServices {
	...
	public OAuth2Authentication loadAuthentication(String accessToken)
		...
		try {
			userDetails = optional.get().loadUserByUser(myUser);
		}
		catch (UsernameNotFoundException notFoundException) {
			throw new UnauthorizedException(String.format("%s username not found", myUser.getUsername()),
					notFoundException);
		}
