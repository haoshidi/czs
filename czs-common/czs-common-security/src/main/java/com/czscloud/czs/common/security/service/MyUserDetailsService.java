...
import com.czscloud.czs.upms.admin.api.entity.SysUser;
...
public interface MyUserDetailsService extends UserDetailsService, Ordered {
	 ...
	 * @return
	 */
	default UserDetails loadUserByUser(MyUser myUser) {
		return this.loadUserByUsername(myUser.getUsername());
	}
