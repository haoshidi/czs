...
package com.czscloud.czs.auth.config;

import com.czscloud.czs.common.core.constant.SecurityConstants;
import com.czscloud.czs.common.security.component.MyWebResponseExceptionTranslator;
import com.czscloud.czs.common.security.grant.ResourceOwnerCustomeAppTokenGranter;
import com.czscloud.czs.common.security.service.MyClientDetailsService;
import com.czscloud.czs.common.security.service.MyCustomAuthenticationProvider;
import com.czscloud.czs.common.security.service.MyCustomTokenServices;
import com.czscloud.czs.common.security.service.MyUser;
...
public class AuthorizationServerConfiguration extends AuthorizationServerConfigurerAdapter {
	...
	public TokenEnhancer tokenEnhancer() {
		return (accessToken, authentication) -> {
			...
			additionalInfo.put(SecurityConstants.DETAILS_USER, myUser);
			((DefaultOAuth2AccessToken) accessToken).setAdditionalInformation(additionalInfo);
			return accessToken;
		};
	}
	...
	@Bean
	public MyCustomAuthenticationProvider authenticationProvider(PasswordEncoder passwordEncoder) {
		MyCustomAuthenticationProvider authenticationProvider = new MyCustomAuthenticationProvider();
		authenticationProvider.setPasswordEncoder(passwordEncoder);
		return authenticationProvider;
	}

	@Bean
	public MyCustomTokenServices tokenServices() {
		MyCustomTokenServices tokenServices = new MyCustomTokenServices();
